                            ...
                            foreach ($data as $d) {
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    <div class="ag-courses_item" style="width:350px;">
                                        <a href="/ENSAHify/views/student/affichage.php?id=<?php echo $d['nom_filiere']; ?>&semestre=1" class="ag-courses-item_link" style="background:#3d5ee1;">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    <div class="ag-courses_item" style="width:350px;margin-left:60px;">
                                        <a href="/ENSAHify/views/student/affichage.php?id=<?php echo $d['nom_filiere']; ?>&semestre=2" class="ag-courses-item_link" style="background:#3d5ee1;">
                                            <div class="ag-courses-item_bg"></div>
                                            <div class="ag-courses-item_title"  >
