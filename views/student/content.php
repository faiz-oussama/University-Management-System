<link rel="stylesheet" href="/ENSAHify/public/assets/plugins/simple-calendar/simple-calendar.css">
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="/ENSAHify/public/assets/img/icons/student-icon-01.svg" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="/ENSAHify/public/assets/img/icons/student-icon-02.svg" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="dash-details">
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-01.svg" alt="">
                                            </div>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-02.svg" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Lessons</h5>
                                                <h4>5 Lessons</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-03.svg" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Time</h5>
                                                <h4>Lessons</h4>
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="dash-details">
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-04.svg" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Assignment</h5>
                                                <h4>5 Assignments</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-05.svg" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Staff</h5>
                                                <h4>John Doe</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="/ENSAHify/public/assets/img/icons/lesson-icon-06.svg" alt="">
                                            </div>
                                            <div class="views-lesson">
