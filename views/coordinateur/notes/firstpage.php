                            ...
                            <div class="parent">
                                    <div class="card">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="mainx">  
                                                <a href="/ENSAHify/views/coordinateur/notes/choixModule.php?level=<?php echo $d['level'];?>&semestre=1">
                                                    <div class="view-more">
                                            ...
                                            <div class="mainy">  
                                                <a href="/ENSAHify/views/coordinateur/notes/choixModule.php?level=<?php echo $d['level']; ?>&semestre=2">
                                                    <div class="view-more">
