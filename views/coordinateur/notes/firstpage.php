                        ...
                        <?php foreach ($data as $d){
                            ...
                            <div class="card flex-fill bg-white" style="width:fit-content;margin-left:10px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="card-link" href="/ENSAHify/views/coordinateur/notes/choixModule.php?level=<?php echo $d['level'];?>&semestre=1">Semestre 1</a>
                                    <a class="card-link" href="/ENSAHify/views/coordinateur/notes/choixModule.php?level=<?php echo $d['level']; ?>&semestre=2">Semestre 2</a>
                                </div>
                            </div>
                        <?php } 
                        ?>  
