    ...
    <div class="main-wrapper">
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <form method="POST" action="/ENSAHify/views/coordinateur/notes/NoteCsv.php"  onsubmit="return validateForm(event)" >
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            <thead class="student-thread">
                                                <tr>
                                                    ...
                                                    <?php foreach ($modules as $module): ?>
                                                        <th><?php echo htmlspecialchars(ucfirst($module['name'])); ?></th>
                                                    <?php endforeach; ?>
                                                    <th>Moyenne</th>
                                                    <th>Status</th>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="student-details.html"><?php echo ucfirst($student['info']['nom']) . " " . ucfirst($student['info']['prénom']); ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo $CNE ?></td>
                                                    <?php 
                                                    ...
                                                    ?>
                                                        <td>
                                                            <?php
                                                            echo '<input class="form-control" style="width:170px;border-radius:20px;" name="grades[' . $CNE . '][' . $module['id'] . ']" type="number" step="0.5" min="0" max="20" placeholder="Enter Moyenne" value="' . htmlspecialchars($grade) . '" readonly>';
                                                            ?>
                                                        </td>
                                                    <?php endforeach; ?>
                                                    <?php 
                                                    ...
                                                    <td>
                                                        <div id="status-<?php echo $CNE; ?>" style="margin-top: 5px;">
                                                            <?php
                                                            echo $averageGrade >= 12 ? '<span class="badge badge-success">Validé</span>' : '<span class="badge badge-danger">Non Validé</span>';
                                                            ?>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="buttons" style="margin-right:40px;display:flex;justify-content:right;align-items:center;flex-direction:row;">
                        <button type="submit" name="exporter" class="btn btn-block btn-outline-success active" style="margin-bottom:20px;width:100px;margin-right:8px">Exporter</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            function updateStatus(input) {
                ...
                if (statusElement) {
                    if (grade !== '') {
                        ...
                        statusElement.innerHTML = grade >= 12 ? '<span class="badge badge-success">Validé</span>' : '<span class="badge badge-danger">Non Validé</span>';
                    } else {
                        statusElement.innerHTML = '<span class="badge badge-warning">Incomplete</span>';
                    }
                }
            }
            function myFunction() {
