                        ...
                        <?php foreach ($data as $d){
                            ...
                            <div class="parent">
                                    <div class="card">
                                        ...
                                        <div class="glass"></div>
                                        <div class="content">
                                            <span class="title"><?php echo $d['nom_complet']." - ".$d['level'] ?></span>
                                            <div class="mainx">  
                                                <a href="/ENSAHify/views/coordinateur/timetable/timetable.php?level=<?php echo $d['level'];?>&semestre=1">
                                                    <div class="view-more">
                                                        <button class="view-more-button">Semestre 1 &nbsp;<i class="fa fa-angle-down"></i> </button>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="mainy">  
                                                <a href="/ENSAHify/views/coordinateur/timetable/timetable.php?level=<?php echo $d['level']; ?>&semestre=2">
                                                    <div class="view-more">
                                                        <button class="view-more-button">Semestre 2 &nbsp;<i class="fa fa-angle-down"></i> </button>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
