                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card comman-shadow">
                                <div class="card-body">
                                    <form action="/ENSAHify/controllers/AddStudentController.php" method="post">
                                        <div class="row">
                                            <div class="col-12">
                                 ...
                                 ?>
                                    <div id="toast-container" class="toast-container toast-top-right">
                                        <div class="toast toast-success" aria-live="polite" style="display: block; animation: fadeOut 5s forwards;">
                                            ...
                                            <div class="toast-message">Student Added Successfully</div>
                                        </div>
                                    </div>
                    ...
                    ?>
                            <div id="toast-container" class="toast-container toast-top-right">
                                <div class="toast toast-error" aria-live="polite" style="display: block; animation: fadeOut 5s forwards;">
                                    ...
                                    <div class="toast-message">Error while Adding the student</div>
                                </div>
                            </div>
                    <?php
