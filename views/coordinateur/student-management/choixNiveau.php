                    ...
                    <div class="row" >
                        ...
                        <?php foreach ($data as $d){
                            ...
                            <div class="card flex-fill bg-white" style="width:fit-content;margin-left:10px">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Veuillez choisir le niveau souhaiter :</p>
                                    <a class="card-link" href="/ENSAHify/views/coordinateur/student-management/view_student.php?level=<?php echo $d['level'];?>">Accéder</a>
                                </div>
                            </div>
                        <?php } 
                        ?>  
